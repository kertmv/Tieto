...
<body>
    <div class="container">
        ...
        <section class="mb-4">
            <a href="lisaasutus.php" class="btn btn-success">Lisa koht</a>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="admin-bar" style="width: 20%;">Admin</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        ?>
                        <tr>
                            <td style="width: 25%;"><a href="lisahinnang.php?asukoht=<?php echo urlencode($asukohaid); ?>"><?php echo htmlspecialchars($row["nimi"]); ?></a></td>
                            ...
                            <td class="admin-bar" style="width: 20%;">
                                <div class="btn-group" role="group" aria-label="Admin actions">
                                    <a href="muudaasutus.php?id=<?php echo urlencode($asukohaid); ?>" class="btn btn-warning btn-sm">Muuda</a>
                                    <a href="kustutaasutus.php?id=<?php echo urlencode($asukohaid); ?>" class="btn btn-danger btn-sm">Kustuta</a>
                                </div>
                            </td>
                        </tr>
                        <?php
